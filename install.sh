...
mkdir -p "$TARGET_ROOT/skills/modular-operating-layer/agents"
mkdir -p "$TARGET_ROOT/skills/modular-operating-layer/boards"
mkdir -p "$TARGET_ROOT/skills/modular-operating-layer/templates"
...
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/SKILL.md" "$TARGET_ROOT/skills/modular-operating-layer/SKILL.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/README.md" "$TARGET_ROOT/skills/modular-operating-layer/README.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/agents/openai.yaml" "$TARGET_ROOT/skills/modular-operating-layer/agents/openai.yaml"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/README.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/README.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/01-content-creation.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/01-content-creation.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/02-sensitive-preflight.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/02-sensitive-preflight.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/03-lajianlouwang-publishing.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/03-lajianlouwang-publishing.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/04-structure-coaching.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/04-structure-coaching.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/05-feedback-history.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/05-feedback-history.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/06-experiment-knowledge.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/06-experiment-knowledge.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/07-evaluation-observability.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/07-evaluation-observability.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/08-human-governance.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/08-human-governance.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/boards/09-distribution-audience-assets.md" "$TARGET_ROOT/skills/modular-operating-layer/boards/09-distribution-audience-assets.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/templates/board-registry-entry.template.md" "$TARGET_ROOT/skills/modular-operating-layer/templates/board-registry-entry.template.md"
copy_shared "$SCRIPT_DIR/skills/modular-operating-layer/templates/board-state-card.template.md" "$TARGET_ROOT/skills/modular-operating-layer/templates/board-state-card.template.md"
...
create_if_missing "$SCRIPT_DIR/memory/topics/modular-operating-layer.template.md" "$TARGET_ROOT/memory/topics/modular-operating-layer.md"
