...
mkdir -p "$TARGET_ROOT/skills/uptoxhs/agents"
...
copy_shared "$SCRIPT_DIR/skills/uptoxhs/SKILL.md" "$TARGET_ROOT/skills/uptoxhs/SKILL.md"
copy_shared "$SCRIPT_DIR/skills/uptoxhs/agents/openai.yaml" "$TARGET_ROOT/skills/uptoxhs/agents/openai.yaml"
